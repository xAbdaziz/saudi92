...
{for(var i = 0, len = gdjs.GameCode.GDScoreTextObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDScoreTextObjects2[i].setString("اضغط اي زر للبدء");
}
...
gdjs.copyArray(runtimeScene.getObjects("Limit"), gdjs.GameCode.GDLimitObjects2);
gdjs.copyArray(runtimeScene.getObjects("TutorialSprite"), gdjs.GameCode.GDTutorialSpriteObjects2);
gdjs.copyArray(runtimeScene.getObjects("TutorialTouchscreenDuck"), gdjs.GameCode.GDTutorialTouchscreenDuckObjects2);
gdjs.copyArray(runtimeScene.getObjects("TutorialTouchscreenJump"), gdjs.GameCode.GDTutorialTouchscreenJumpObjects2);
{for(var i = 0, len = gdjs.GameCode.GDTutorialTouchscreenJumpObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDTutorialTouchscreenJumpObjects2[i].hide();
}
for(var i = 0, len = gdjs.GameCode.GDTutorialTouchscreenDuckObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDTutorialTouchscreenDuckObjects2[i].hide();
}
for(var i = 0, len = gdjs.GameCode.GDLimitObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDLimitObjects2[i].hide();
}
for(var i = 0, len = gdjs.GameCode.GDTutorialSpriteObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDTutorialSpriteObjects2[i].hide();
}
}{for(var i = 0, len = gdjs.GameCode.GDDinoObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects2[i].setAnimationName("Run");
}
}{for(var i = 0, len = gdjs.GameCode.GDDinoObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects2[i].activateBehavior("PlatformerObject", true);
}
}{gdjs.evtTools.sound.playMusic(runtimeScene, "DesertMusic.mp3", true, 35, 1);
}}
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition0IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9335884);
}
}if (gdjs.GameCode.condition0IsTrue_0.val) {
}
...
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9337484);
}
}}
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition1IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9338332);
}
}}
if (gdjs.GameCode.condition1IsTrue_0.val) {
...
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9340156);
}
}}
}
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition1IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9340860);
}
}}
if (gdjs.GameCode.condition1IsTrue_0.val) {
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition1IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9336620);
}
}}
if (gdjs.GameCode.condition1IsTrue_0.val) {
}
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "Bonus.mp3", false, 80, 0.5);
}}
...
gdjs.copyArray(runtimeScene.getObjects("ScoreText"), gdjs.GameCode.GDScoreTextObjects2);
{for(var i = 0, len = gdjs.GameCode.GDScoreTextObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDScoreTextObjects2[i].setString(gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(0)));
}
}
{ //Subevents
